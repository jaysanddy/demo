...
(function() {
	...
	MobileSelect.prototype = {
		...
		init: function(config){
			var _this = this; 
			_this.keyMap = config.keyMap ? config.keyMap : {areaId:'areaId', riverName:'riverName', childs:'childs'};
			_this.checkDataType();
		...
		renderWheels: function(wheelsData, cancelBtnText, ensureBtnText){
			...
			//列
				...
				if(_this.jsonType){
					...
					//行
						tempHTML += '<li data-id="'+wheelsData[i].data[j][_this.keyMap.id]+'">'+wheelsData[i].data[j][_this.keyMap.riverName]+'</li>';
					}
				}else{
					for(var j=0; j<wheelsData[i].data.length; j++){ 
					//行
		...
		generateArrData: function (targetArr) {
			...
			var keyMap_value = this.keyMap.riverName;
			for(var i=0; i<targetArr.length; i++){
				var tempObj = {}; 
				tempObj[keyMap_id] = targetArr[i][this.keyMap.id];
				tempObj[keyMap_value] = targetArr[i][this.keyMap.riverName];
			...
			//列
				(function (i) {
					...
					if(_this.wheel[i]){
						...
						//行
							tempHTML += '<li data-id="'+_this.displayJson[i][j][_this.keyMap.id]+'">'+_this.displayJson[i][j][_this.keyMap.riverName]+'</li>';
						}
		...
		updateWheel: function(sliderIndex, data){
	    	...
	    	if(_this.cascade){
				...
				for(var j=0; j<data.length; j++){
					tempHTML += '<li data-id="'+data[j][_this.keyMap.id]+'">'+data[j][_this.keyMap.riverName]+'</li>';
				}
