...
public class UserController {
    ...
    public Result createUser( @RequestParam String realName, @RequestParam String password, String remark, @RequestParam Integer areaId,@RequestParam Integer roleId,@RequestParam String phone){
        return userService.createUser( realName, password, remark, areaId,roleId,phone);
    }

    //获取用户列表
    @RequestMapping("getUserByAreaId")
    public ResultData getUserByAreaId(Integer areaId,Integer roleId,String realName,@RequestParam(name = "page",defaultValue = "1") Integer pageNum,
                                      @RequestParam(name = "rows",defaultValue = "10") Integer pageSize){
        return userService.getUserByAreaId(areaId,roleId,realName, pageNum, pageSize);
    }
    ...
    public Result updateUser(@RequestParam Integer userId,@RequestParam String realName,String password,String remark,@RequestParam Integer areaId,Integer status,@RequestParam Integer roleId,@RequestParam String phone){
        return userService.updateUser(userId,realName, password, remark, areaId, status,roleId,phone);
    }
}
